package liuli.games.order.config;

import liuli.games.order.mqcallback.MsgSendConfirmCallBack;
import liuli.games.order.mqcallback.MsgSendReturnCallback;
...
public class RabbitMqConfig {
     ...
     * 队列key1
     */
    public static final String ROUTING_KEY_1 = "queue_key1";
    /**
     * 队列key1
     */
    public static final String ROUTING_KEY_2 = "queue_key2";
