package liuli.games.store.consumer;

import com.google.gson.Gson;
import com.rabbitmq.client.Channel;
import liuli.games.store.pojo.Order;
...
public class OrderConsumer {
    ...
    public final String QUEUE_NAME3 = "third-queue";
    ...
    public void handleMessage(Message message, Channel channel) throws IOException {
        try {
            ...
            //执行减库存操作
            System.out.println(new Gson().fromJson(new String(message.getBody()), Order.class));
            /**
